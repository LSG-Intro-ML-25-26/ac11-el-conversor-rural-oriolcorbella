...
controller.B.onEvent(ControllerButtonEvent.Pressed, function () {
    if (msg == 1) {
        ...
        arbre_3 = sprites.create(img`
            ...
            ...............ffceec...............
            `, SpriteKind.Enemy)
        arbre_1.setPosition(28, 82)
        arbre_2.setPosition(67, 71)
        arbre_3.setPosition(106, 81)
    }
    msg = 0
})
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    if (info.score() < 100) {
        ...
        nena.sayText("No puc recollir mes troncs", 10000, true)
    }
})
...
let arbres_talats = 0
let msg = 0
let arbre_3: Sprite = null
let arbre_2: Sprite = null
let arbre_1: Sprite = null
...
arbre_3 = sprites.create(img`
    ...
    ...............ffceec...............
    `, SpriteKind.Enemy)
nena.setPosition(131, 91)
arbre_1.setPosition(28, 82)
arbre_2.setPosition(67, 71)
arbre_3.setPosition(106, 81)
info.setScore(0)
forever(function () {
    if (arbres_talats == 3 && msg == 0) {
        arbres_talats = 0
        pause(500)
        nena.sayText("Clica B per plantar", 2000, false)
        msg = 1
    }
})
