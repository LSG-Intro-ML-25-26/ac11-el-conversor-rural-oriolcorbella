...
def on_b_pressed():
    global msg, arbre_1, arbre_2, arbre_3
    if msg == 1:
        nena.say_text("")
        msg = 0
        arbre_1 = sprites.create(img("""
                ................86..................
                ...........6688867886...............
                ...........8666877688868............
                ............868777767768............
        ...
        arbre_3 = sprites.create(img("""
                ...
                """),
            SpriteKind.enemy)
        arbre_1.set_position(28, 82)
        arbre_2.set_position(67, 71)
        arbre_3.set_position(106, 81)
    msg = 0
...
def on_a_pressed():
    ...
    animation.run_image_animation(nena, assets.animation("""
        ...
        """), 200, False)
    if info.score() < 100:
        if nena.overlaps_with(arbre_1):
            sprites.destroy(arbre_1, effects.spray, 500)
            info.set_score(info.score() + 3)
            arbres_talats = arbres_talats + 1
        elif nena.overlaps_with(arbre_2):
            sprites.destroy(arbre_2, effects.spray, 500)
            info.set_score(info.score() + 3)
            arbres_talats = arbres_talats + 1
        else:
            sprites.destroy(arbre_3, effects.spray, 500)
            info.set_score(info.score() + 3)
            arbres_talats = arbres_talats + 1
    else:
        nena.say_text("No puc recollir mes troncs", 10000, True)
...
def on_menu_pressed():
    ...
    111111d4311111111111111111111
    1111114444d111111111111111111
    11111d44444d11111111111111111
    11111d244442d1111111111111111
    11111d4dd442d1111111111111111
    111113dddd4d11111111111111111
    111d55ddcddd11111111144111111
    114444dddddd11111111444111111
    111124ddddddd1111111444411111
    1111224ddddddd11111d444111111
    1111424ddddddd111144444444111
    1111144ddddddddd1d44444444111
    11111dddddddddddddd44443d1111
    11111ddddd444ddddddd444d11111
    11111ddddd444444dddd4444d1111
    11111ddddd44444444ddd444d1111
    11111ddddd444444444ddddd11111
    11111ddddd444444444dd11111111
    111111ddddddd44444ddd11111111
    111111dddddddddddddd111111111
    1111111dddddddddddd1111111111
    11111111dddddddddd11111111111
    111111111dddddddbd11111111111
    1111111111ddd11dbd11111111111
    111111111114111d3111111111111
    111111111114111d3111111111111
    111111111d44dd444d11111111111
    111111111dd1d1d1dd11111111111
    11111111111111111111111111111
            """),
        SpriteKind.player)
...
def on_forever():
    global arbres_talats, msg
    if arbres_talats == 3 and msg == 0:
        arbres_talats = 0
        pause(500)
        nena.say_text("Clica B per plantar", 2000, False)
        msg = 1
forever(on_forever)
